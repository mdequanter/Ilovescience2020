...
class MultitagPositioning(object):
    ...
    def printPublishPosition(self, position, network_id):
        ...
        #if (network_id == '27211'):
          #print(position.x,position.y,sensor_data.euler_angles.pitch)
        ...
        if (difference > 99.99) :
            difference = 99.99
        newLap = detectFinish(float(position.x), float(position.y),float(sensor_data.euler_angles.pitch), float(difference))
...
def detectFinish(X, Y,heading, timediff):
    global FinishLinePoint1_X, FinishLinePoint1_Y, FinishLinePoint2_X, FinishLinePoint2_Y, minLapTime,FinishHeading1,FinishHeading2

    if (
            X > FinishLinePoint1_X and X < FinishLinePoint2_X and Y > FinishLinePoint1_Y and Y < FinishLinePoint2_Y and timediff > minLapTime and heading > FinishHeading1 and heading < FinishHeading2):
        return 1
    else:
        return 0
...
if __name__ == "__main__":
    ...
    tag_ids = [0x6a69,0x6a4B,0x6a4a,0x6a45]
    #tag_ids = [0x6a4a]
